...
require_once "config.php";
    ...
    $request = json_decode($postdata);
     ...
     $EventDescription=mysqli_real_escape_string($conn,$request->EventDescription);
         ...
         $EventOrganiser3=mysqli_real_escape_string($conn,$request->EventOrganiser2);
          $EventContact3=mysqli_real_escape_string($conn,$request->EventContact3);
          $EntryFee=mysqli_real_escape_string($conn,$request->EntryFee);
          $EventDay=mysqli_real_escape_string($conn,$request->EventDay);
          $Venue=mysqli_real_escape_string($conn,$request->Venue);
              $EventTime=mysqli_real_escape_string($conn,$request->EventTime);
...
$sql = "UPDATE Event SET EntryFee='$EntryFee',EventDay='$EventDay',Venue='$Venue', EventTime='$EventTime', EventName='$EventName',TeamSize='$TeamSize',EventDescription='$EventDescription',EventOrganiser1='$EventOrganiser1',EventContact1='$EventContact1',EventOrganiser2='$EventOrganiser2',EventContact2='$EventContact2',EventOrganiser3='$EventOrganiser3',EventContact3='$EventContact3' WHERE Email='$eid'"; 
